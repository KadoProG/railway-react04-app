...
export const BlogsPage = () => {
  const markdownText = `
  ![Reactの画像](${URL}/images/logo512.png "Reactの画像")

  こんにちは今回はタイピング練習をしていこうと思いますそれでは本日も行ってみましょう。

  しかしながら、本日は寒いですね。寒い中電車を乗り継いで大学に来て朝活をしているのですが、なぜ私は朝活をしているのでしょうか？その答えは、**もっと成長したい、という貪欲な姿勢を持っている**からです。
  ...
  ![XPSの画像](${URL}/images/PSX_20220620_075347.jpg "XPSの画像")
